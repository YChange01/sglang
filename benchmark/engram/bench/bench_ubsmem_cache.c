/**
 * UBS-MEM cacheable load benchmark.
 *
 * Maps the server-created "<name>" object and reads it with CPU loads/memcpy.
 * This is the cacheable UBS-MEM baseline.
 */
...
#define BENCH_TITLE "UBS-MEM Cache Read Benchmark"
#define MODE_NAME "UBS-MEM (cache)"
#define UBSMEM_FLAGS UBSM_FLAG_CACHE
...
int main(int argc, char **argv)
{
    ...
    printf("shmem: %s, size: %zu MB, iters: %d, provider: %s\n",
